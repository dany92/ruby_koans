...
class AboutClassMethods < Neo::Koan
  ...
  #   end
  #
  # Which do you prefer and why? I would use the first if there only a few class methods. 
  # Are there times you might prefer one over the other? prefer the second way if there are a lot of class methods
