...
#Symbols are used for hash keys. NOT to be confused with variables
class AboutSymbols < Neo::Koan
  ...
  def test_symbols_cannot_be_concatenated
    # Exceptions will be pondered further down the path #yea because they are immutable
  ...
  # THINK ABOUT IT:
  # ANSWEr: Unlike Strings, Symbols are immutable and garbage collector won't pick up unused symbols. So they take up space until your program ends
