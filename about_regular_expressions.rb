...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #Stops at the first occurence of the pattern
    # THINK ABOUT IT:
    #
  ...
  def test_character_classes_give_options_for_a_character
    ...
    assert_equal ["cat","bat","rat"], animals.select { |a| a[/[cbr]at/] } #not ideal. if "cbrat" was in the array it prints it. Is there a way to test for conditions?
  end
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    assert_equal nil, "start end"[/\Aend/] #doesn't return ""
  end
  ...
  #Explained: .sub returns the first occurence($1) which is "two" and $1[0,1] slices the substring thus "t"
