...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Describe in your own words what inject does. Inject(0) means the base case is 0. The block goes through each element adding on to the last operation. Like recursion??
  end
  ...
  #   # code to read 'file'
  # Ummm maybe because file = File.open(filename) can't handle an exception??
